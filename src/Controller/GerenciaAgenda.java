...
public class GerenciaAgenda {
	...
	public GerenciaAgenda(ArrayList<Veiculo> arrayVeiculos, ArrayList<Cliente> arrayclientes,
			ArrayList<Locacao> locacoes) {
		super();
	...
	public void agendar() {
		...
		if (tipoVeiculo instanceof Carro) {
			...
			veiculosAdd.add(car);
			Locacao loc = new Locacao(arrayclientes.get(posCliente), veiculosAdd, dataInicio, dataPrevistaDevolucao,
					dataDevolucao, preco, multa, status);
			locacoes.add(loc);
		}
